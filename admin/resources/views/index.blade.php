      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <h3 class="text-center ">Hey {{session('first_name')}}</h3>
            <div class="row my-3">
              <!-- <div class="col-md-3">
                  <div class="card rounded-3 border bg-danger p-2">
                    <h4 class="text-white">Students</h4>
                    <div class="fs-5 text-white">10</div>
                    <div class="text-end text-white">more</div>
                  </div>
                </div> -->
              <div class="col-md-3">
                <div class="card">
              ...
              <div class="col-md-3">
                <div class="card">
                  <div class="card header bg-primary p-2">
                    <span class="fs-5 ms-2 text-white">Partners</span>
                  </div>
                  <div class="card-body py-0">
              ...
              <div class="col-lg-8 mb-4 order-0">
                <div class="card">
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        <h5 class="card-title text-primary">Congratulations John! 🎉 {{ session()->get('email')}}</h5>
                        <p class="mb-4">
                      ...
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="{{ asset('assets/img/icons/unicons/chart-success.png') }}" alt="chart success" class="" />
