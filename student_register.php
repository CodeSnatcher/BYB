...
<body>
            ...
            <div class="d-flex mt-5 border border-dark shadow justify-content-center">
                <div class="col-lg-12 justify-content-center">
                    <div class=" row justify-content-center">
                        <div class="col-md-6">
                            <img src="./assets/images/login-graphic.jpg" alt="" class="  img-fluid d-block mx-auto">
                        </div>
                        <div class="col-md-6 p-5">
                            <form id="student_register" action="phpScript/controllers.php" method="post" class="shadow p-4 ">
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <h2 class="mb-3">Student Register</h2>
                                    </div>
                                    <input type="" class="d-none" name="tag" value="student_register" required>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-3">
                                            <div class="form-floating">
                                                <select class="form-select" id="ph_code" onchange="set_val()" name="phone_code" aria-label="Floating label select example">
                                                ...
                                                <label for="ph_code">Code</label>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="form3Example1n">Phone</label>
                                                <input type="tel" id="form3Example1n" name="phone_no" class="form-control form-control-lg" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-floating">
                                                <select class="form-select" id="w_code" name="whtp_code" aria-label="Floating label select example">
                                                    <option selected>select</option>
                                                    <option data-countryCode="DZ" value="213">Algeria (+213)</option>
                                                    <option data-countryCode="AD" value="376">Andorra (+376)</option>
                                                    <option data-countryCode="AO" value="244">Angola (+244)</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="city" id="floatingInput" required placeholder="name@example.com">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" name="password" required id="new_pass" placeholder="Password">
                                            <label for="new_pass">Password</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" id="con_pass" required placeholder="Password">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="ref_code" placeholder="Password">
                                            <label for="con_pass">Referal Code (Optional)</label>
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" required id="tc">
                                            <label class="form-check-label" for="tc">
                                                Agree to all <a href="termconditions.php">Term & Condition</a>
                                            </label>
                                        </div>
                                    ...
                                    <span class="mt-3">Existing User <a href="https://new.bringyourbuddy.in/student/public/login" class="text-danger">Login</a></span>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        function set_val() {
            var ph_code = document.getElementById("ph_code").value;

            document.getElementById("w_code").value = ph_code;
        }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == "1") {
                            ...
                            setTimeout(function() {
                                window.location.replace("https://new.bringyourbuddy.in/student/public/login");
                            }, 4000);
                        } else {
                            $(".loader").css("display", "none");
                            $.toast({
