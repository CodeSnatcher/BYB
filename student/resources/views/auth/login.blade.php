      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- /Logo -->
            <h4 class="mb-2 text-center text-danger">Student Login</h4>
            ...
            <form action="{{ url('/') }}/login" method="POST" class="user">
              ...
              <div class="text-center">
                <a href="https://new.bringyourbuddy.in/student_register.php" class="text-center text-danger">New User</a>
              </div>
