                                    ...
                                    <div class="formbold-form-wrapper">
                                        <form action="{{ url('/') }}/upload_documents" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="card mb-4 border border-dark">
                                                            <div class="card-body text-center">
                                                                ...
                                                                <div class="d-flex justify-content-between mb-3">
                                                                    ...
                                                                    <div>{{$studata->gender;}}</div>
                                                                </div>
                                                                <hr>
                                                                <hr>
                                                                <div class="d-flex justify-content-between mb-3">
                                                                    <div class="text-dark">Email</div>
                                                                    <div>{{$studata->email;}}</div>
                                                                </div>
                                                                <hr>
                                                                <div class="d-flex justify-content-between mb-3">
                                                                    <div class="text-dark">Phone</div>
                                                                    <div>{{$studata->phone_no;}}</div>
                                                                </div>
                                                                <hr>
                                                                <hr>
                                                                <div class="d-flex justify-content-between mb-3">
                                                                    <div class="text-dark">Status</div>
                                                                    <div>{{$studata->marital_status;}}</div>
                                                                </div>
                                                                <input type="text" hidden name="stu_id" value="{{$studata->id;}}">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                    </div>
                                            ...
                                            <div class="formbold-form-step-3">
                                                ...
                                                @if(optional($studoc)->certificate_10 != "" || optional($studoc)->certificate_12 != "" || optional($studoc)->certificate_other != "")
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="collapse" id="certificate_10">
                                                            <div class="card card-body">
                                                                <ul>
                                                                    <li>
                                                                        <a href="{{ asset('uploads/student_document/certificate_10/'.optional($studoc)->certificate_10)}}" target="_blank" class="text-dark"> View Doc </a>
                                                                    </li>
                                                                    <li>
                                                                        ...
                                                                        <div class="collapse" id="update_certificate_10">
                                                                            <div class="card card-body">
                                                                                ...
                                                                                <button type="button" onclick='update_10_doc({{$studata->id;}})' class="btn btn-primary form-control">Update</button>
                                                    ...
                                                    <div class="my-3">
                                                        ...
                                                        <div class="collapse" id="certificate_12">
                                                            <div class="card card-body">
                                                                <ul>
                                                                    <li>
                                                                        <a href="{{ asset('uploads/student_document/certificate_12/'.optional($studoc)->certificate_12)}}" target="_blank" class="btn btn-dark me-2 btn-sm"> View Doc </a>
                                                                    </li>
                                                                    <li>
                                                                        ...
                                                                        <div class="collapse" id="update_certificate_12">
                                                                            <div class="card card-body">
                                                                                <input type="text" readonly value="{{$studoc->certificate_12;}}">
                                                                                <form action="">
                                                                                    @csrf
                                                                                    <input type="text" name="stu_id" hidden value="{{$studata->id;}}" id="">
                                                                                    <div class="mb-3">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <div class="collapse" id="update_certificate_other">
                                                                            <div class="card card-body">
                                                                                <input type="text" readonly value="{{$studoc->certificate_other;}}">
                                                                                <form action="">
                                                                                    @csrf
                                                                                    <input type="text" name="stu_id" hidden value="{{$studata->id;}}" id="">
                                                                                    <div class="mb-3">
                                                ...
                                                <div class="card p-3 rounded-3 border border-primary">
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1" class="form-label">10th</label>
                                                        <input type="file" class="form-control" name="certificate_10" id="exampleFormControlInput1" placeholder="name@example.com">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1" class="form-label">12th</label>
                                                        <input type="file" class="form-control" name="certificate_12" id="exampleFormControlInput1" placeholder="name@example.com">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1" class="form-label">Other</label>
                                                        <input type="file" class="form-control" name="certificate_other" id="exampleFormControlInput1" placeholder="name@example.com">
                                                    </div>
                                                </div>
                                                @endif
