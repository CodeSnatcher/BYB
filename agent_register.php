                ...
                <div class="d-flex mt-5 border border-dark shadow justify-content-center">
                    <form id="university_register" action="phpScript/controllers.php" method="post" class="shadow p-4 ">
                        <div class="row justify-content-evenly align-items-center">
                            <div class="col-md-12">
                                <h2 class="mb-3">Agent Register</h2>
                                <input type="" class="d-none" name="tag" value="agent
                                _register" required>

                            </div>
                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="first_name" required id="floatingInput" placeholder="name@example.com">
                            ...
                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="last_name" required id="floatingInput" placeholder="name@example.com">
                            ...
                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    <input type="tel" class="form-control" name="phone_no" required id="floatingInput" placeholder="name@example.com">
                            ...
                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    <select class="form-select" id="floatingSelect" name="contact_method" aria-label="Floating label select example">
                                    ...
                                    <label for="floatingSelect">Contact Method</label>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    <select class="form-select" id="floatingSelect" name="find_out" aria-label="Floating label select example">
                                        <option selected>select</option>
                                        <option value="Social Media Platform">Social Media Platform</option>
                                        <option value="LinkedIn">LinkedIn</option>
                                        <option value="Word Of Mouth">Word Of Mouth</option>
                                        <option value="Through an Student">Through a Student</option>
                                        <option value="BringYourBuddy Approached Me">BringYourBuddy Approached Me</option>
                                        
                                    </select>
                                    <label for="floatingSelect">How Did You Find Out About Bring Your Buddy ?</label>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" name="reference	" required id="floatingInput" placeholder="name@example.com">
                                    <label for="floatingInput">IN WHICH YEAR DID YOU BEGIN RECRUITING STUDENTS?</label>
                                </div>

                            </div>
                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="recruiting_year" required id="floatingInput" placeholder="name@example.com">
                                    <label for="floatingInput">HAS ANYONE AT APPLYBOARD REFERRED YOU?IF YES,WHO?</label>
                                </div>
                            ...
                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingSelect"> SPECIFY THE MAIN SOURCE COUNTRY OF YOUR STUDENTS</label>
                                </div>
                            </div>

                            <div class="col-md-5">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="services" required id="floatingInput" placeholder="name@example.com">
                                    <label for="floatingInput">WHAT SERVICES DO YOU PROVIDE TO YOUR CLIENTS?</label>
                                </div>
