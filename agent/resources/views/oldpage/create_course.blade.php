          ...
          <div class="row d-flex justify-content-start">
            <div class="col-md-12">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="POST" action="{{ url('/') }}/add_courses" enctype="multipart/form-data">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="row mb-3">
                      <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="course_eligibility" name="course_eligibility" placeholder="Course Eligibility">
                      </div>

                      <div class="col-md-4">
                        <label class="form-label" for="course_duration_year">Course Duration Year(Year)</label>
                        <input type="text" class="form-control" id="course_duration_year" name="course_duration_year" placeholder="Course Duration Year">
                      </div>
                      <div class="col-md-4">
                        <label class="form-label" for="course_duration_sem">Course Duration Semester(Sem)</label>
                        <input type="text" class="form-control" id="course_duration_sem" name="course_duration_sem" placeholder="Course Duration Semester">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <div class="col-md-4">
                        <label class="form-label" for="course_duration_month">Course Duration Month(Months)</label>
                        <input type="text" class="form-control" id="course_duration_month" name="course_duration_month" placeholder="Course Duration Month">
                      </div>
