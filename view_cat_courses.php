...
<body style="background-color: #F7F7F7 !important;">
    ...
    $db = new DB_Functions();
    $cat_id = $_GET['cat_id'];
    $university_courses = $db->catwisecourse($cat_id, $duration, $price, $search)
        ...
        <div class="container">
            <div class="my-5">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <form action="">
                            <input type="text" hidden name="cat_id" value="<?php echo $_REQUEST['cat_id']; ?>">
                    ...
                    <div class="col-md-9">
                        <form method="get" action="view_cat_courses.php">
                                            ...
                                            <div class="card border border-dark h-100" style="border-radius: 20px !important;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <a href="https://new.bringyourbuddy.in/student/public/login" class="text-primary fw-bold ">Apply Now <i class="fa-solid fa-pen-to-square ms-1"></i></a>
                                                        <a href="<?php echo 'course_details.php?id=' . $university_courses[$i]['course_id']; ?>" class=" text-danger fw-bold"> View Course </a>
                                                    </div>
